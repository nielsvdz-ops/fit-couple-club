...
const workouts = {
  ...
  bootyUpperBalance: {
    ...
    warmup: ["5 minutes easy cardio", "Band pull-aparts", "Shoulder circles"],
    steps: [
      {
  ...
  couplesWalkCheckin: {
    ...
    steps: [
      ...
      },
      {
        ...
        reps: "10 minutes",
        rest: "-",
        notes: "Focus on hips, shoulders, and spine.",
      },
      {
  ...
  couplesUpperConditioning: {
    ...
    warmup: ["5 minutes easy cardio", "Shoulder circles", "Band pull-aparts"],
    steps: [
      {
        exercise: "Dumbbell Shoulder Press",
        sets: "3",
  ...
  couplesChallengeDay: {
    ...
    finisher: ["Short easy walk cooldown", "Celebrate the session and log it"],
  },
