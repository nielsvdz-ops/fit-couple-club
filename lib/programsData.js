// programsData.js v2
// Added:
// - EN/NL translation support
// - Current memberships (nutrition/full_access/vip/coaching)
// - Removed Starter/Premium wording
// - Mobile-friendly metadata helpers
...
export const PROGRAM_TRANSLATIONS = {
  ...
  nl: {
    ...
    advanced: "Gevorderd",
    moderate: "Gemiddelde Intensiteit",
    high: "Hoge Intensiteit",
    low: "Lage Intensiteit",
    daysPerWeek: "dagen / week",
  },
};

export function translateProgramText(value, language = "en") {
...
export function normalizeProgramMembership(value = "full_access") {
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "8k–10k steps equivalent movement target",
        rest: "-",
        notes:
      ...
      },
      {
        exercise: "Plank",
        sets: "1",
        reps: "8–10 min mobility flow",
        rest: "-",
        notes:
          "Use this block as a recovery placeholder until you add non-lift recovery media.",
      },
    ],
    ...
    steps: [
      {
        ...
        notes:
          "Use this as your power movement in the circuit.",
      },
      {
        exercise: "Step-Up",
        sets: "3 rounds",
        ...
        rest: "0 sec",
        notes:
          "Use a stable bench or box and keep the pace controlled.",
      },
      {
        exercise: "Push-Up",
        sets: "3 rounds",
        reps: "40 sec work / 20 sec rest",
        rest: "0 sec",
        notes: "Keep reps clean even under fatigue.",
      },
      {
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "20–40 minutes easy walk equivalent",
        rest: "-",
      ...
      },
      {
        exercise: "Plank",
        sets: "1",
        reps: "10–15 minutes mobility flow",
        rest: "-",
        notes:
          "Use this block as a recovery placeholder until you add dedicated recovery media.",
      },
    ],
    finisher: [
      "Review your week",
  ...
  bootyGluteHypertrophy: {
    ...
    steps: [
      ...
      },
      {
        ...
        reps: "20–25",
        rest: "30 sec",
        notes: "Placeholder until you add glute-specific burnout media.",
      },
    ],
  ...
  bootyHamQuad: {
    ...
    steps: [
      ...
      },
      {
        ...
        reps: "12–15",
        rest: "30 sec",
        notes: "Use this as your lower-body support finisher.",
      },
    ],
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "20–30 min easy walk equivalent",
        rest: "-",
      ...
      },
      {
        exercise: "Plank",
        sets: "1",
        reps: "10–15 min mobility flow",
        rest: "-",
        notes:
          "Use this block as a recovery placeholder until you add dedicated mobility media.",
      },
    ],
    finisher: [
      "Hydrate well",
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "8k–10k daily steps equivalent",
        rest: "-",
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "20–40 minutes walk together equivalent",
        rest: "-",
        notes:
      ...
      },
      {
        exercise: "Crunch",
        sets: "1",
        reps: "5–10 minutes check-in",
        rest: "-",
        notes:
          "Use this as a placeholder until you add non-lift partner check-in media.",
      },
    ],
    finisher: [
    ...
    steps: [
      {
        ...
        notes:
          "Use this with push-ups, rows, mountain climbers, and step-ups.",
      },
      {
        exercise: "Push-Up",
        sets: "3 rounds",
      ...
      },
      {
        ...
        rest: "30 sec",
        notes:
          "Use this as part of the challenge finisher.",
      },
    ],
    finisher: [
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "20–40 min easy walk equivalent",
        rest: "-",
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "15–30 min easy walk equivalent",
        rest: "-",
        notes:
          "Use it to reduce stiffness and improve recovery.",
      },
      {
        exercise: "Plank",
        sets: "1",
    ...
    steps: [
      {
        exercise: "Walking Lunges",
        sets: "1",
        reps: "20–40 minutes light walk equivalent",
        rest: "-",
  ...
  starterWalkStretch: {
    ...
    steps: [
      ...
      },
      {
        exercise: "Plank",
        sets: "1",
        reps: "8–10 min light stretch flow",
        rest: "-",
        notes: "Focus on hips, back, and shoulders.",
      },
    ],
  ...
  starterLowerBasics: {
    ...
    steps: [
      ...
      },
      {
        ...
        reps: "12–15",
        rest: "30 sec",
        notes: "Use as a calf/support finisher placeholder.",
      },
    ],
  ...
  starterRecoveryDay: {
    ...
    steps: [
      ...
      },
      {
        exercise: "Plank",
        sets: "1",
        reps: "8–10 min gentle stretch flow",
        rest: "-",
...
export function getTranslatedPrograms(programs = [], language = "en") {
  return programs.map((program) => ({
    ...program,
    title: translateProgramText(program.title || "", language),
    subtitle: translateProgramText(program.subtitle || "", language),
    description: translateProgramText(program.description || "", language),
    level: translateProgramText(program.level || "", language),
    intensity: translateProgramText(program.intensity || "", language),
    focus: translateProgramText(program.focus || "", language),
    access: normalizeProgramMembership(
      program.access ||
      program.membership ||
      program.requiredMembership ||
      "full_access"
    ),
  }));
}
