...
export const GOALS = {
  "lose-fat": {
    ...
    description:
      "Higher protein meals, controlled calories, and simple structure focused on sustainable fat loss.",
    example: [
      "Breakfast: Eggs + oats",
  ...
  "build-muscle": {
    ...
    description:
      "Higher calorie structure with strong protein intake and meals built around recovery and muscle growth.",
    example: [
  ...
  "tone-shape-body": {
    ...
    description:
      "Balanced meals focused on body composition, energy, and shaping a lean athletic physique.",
    example: [
  ...
  "maintain-athletic-lifestyle": {
    ...
    description:
      "Performance-focused meals that support energy, recovery, and long-term consistency.",
    example: [
  ...
  "beginner-body-reset": {
    ...
    description:
      "Simple, repeatable meals with a strong protein base and easy food choices.",
    example: [
