...
const card = { background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "22px", padding: "22px" };
const programTop = { display: "flex", justifyContent: "space-between", gap: "12px", alignItems: "start" };
const programTitle = { fontSize: "24px", fontWeight: "800", marginBottom: "6px" };
const muted = { color: "rgba(255,255,255,0.62)", lineHeight: 1.7 };
const badge = { padding: "8px 10px", borderRadius: "12px", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.08)", fontWeight: "700", fontSize: "12px" };
const label = { color: "rgba(255,255,255,0.52)", fontSize: "12px", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: "8px" };
