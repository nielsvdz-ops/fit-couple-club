...
const programs = [
  { title: "30-Day Lean Reset", text: "Routine, consistency, cleaner eating, and visible momentum." },
  { title: "Build Curves / Booty Builder", text: "Lower body growth focus with glute-heavy structure." },
  { title: "Couple Transformation Challenge", text: "Shared discipline and accountability together." },
  { title: "Lean Muscle Blueprint", text: "Muscle gain with controlled nutrition and performance focus." },
];
...
const cardTitle = { fontSize: "24px", fontWeight: "800", marginBottom: "10px" };
const cardText = { color: "rgba(255,255,255,0.7)", lineHeight: 1.7 };import { redirect } from "next/navigation";
